...
use candela_core::harness::{self, ChatEvent as CoreChatEvent, HarnessError, new_session};
...
// These are cross-crate adapters between the hand-written ChatEvent enum
// in candela-core (JSON-RPC format) and the proto-generated buffa types.
// Session/SearchResult converters will be auto-generated by proto2type.
...
#[allow(clippy::field_reassign_with_default, clippy::useless_conversion)]
fn domain_chat_event_to_proto(event: &CoreChatEvent) -> SendMessageResponse {
